...
public class Person {
	...
	public static void main(String[] args) {
		List<Person> arr = createRoster();
		arr.stream().forEach(i -> System.out.println(i.getName()));
		arr.stream().filter(i -> i.getGender().equals(Sex.MALE)).forEach(i -> System.out.println(i.getName()));
		System.out.println(arr.stream().filter(i -> i.getGender().equals(Sex.MALE)).mapToInt(i -> i.getAge()).average()
				.getAsDouble());
	}
}